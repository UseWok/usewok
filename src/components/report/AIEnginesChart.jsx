...
const GeminiSVG = () => (
  <svg width="13" height="13" viewBox="0 0 24 24" fill="none">
    <defs>
      <linearGradient id="gem-c" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="#4285F4"/>
        <stop offset="50%" stopColor="#9B72CB"/>
        <stop offset="100%" stopColor="#D96570"/>
      </linearGradient>
    </defs>
    <path d="M12 2C12 2 9.5 8.5 2 12C9.5 15.5 12 22 12 22C12 22 14.5 15.5 22 12C14.5 8.5 12 2Z" fill="url(#gem-c)"/>
  </svg>
);
...
function AILogo({ name, size = 20 }) {
  const svgMap = { ChatGPT: <ChatGPTSVG />, Gemini: <GeminiSVG />, Claude: <ClaudeSVG /> };
  return (
