    ...
    <div style={{ background: CREAM, fontFamily: F, minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 680, margin: '0 auto', position: 'relative', zIndex: 2 }}>
          <div style={{
            ...
            <span style={{ fontSize: 11, color: ORANGE_DEEP, fontWeight: 700, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Contrat d'utilisation</span>
          </div>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '40px clamp(20px, 3vw, 40px) 0' }}>
        <div style={{
          ...
          <P>Les présentes Conditions Générales d'Utilisation (les « CGU » ou les « Conditions ») constituent un contrat entre <strong>UseWok</strong> [forme juridique à compléter dès l'immatriculation], dont le siège social est situé [adresse complète à compléter — Gironde, France] (« nous », « UseWok », « la Société »), et toute personne utilisant le service accessible à l'adresse <a href="https://usewok.com" style={{ color: ORANGE_DEEP }}>https://usewok.com</a> (le « Service », l'« Utilisateur », « vous »).</P>
          <P style={{ marginBottom: 0 }}>En créant un compte ou en utilisant le Service, vous acceptez pleinement et sans réserve les présentes Conditions ainsi que notre <Link to="/privacy" style={{ color: ORANGE_DEEP }}>Politique de Confidentialité</Link>. Si vous n'acceptez pas ces Conditions, vous ne devez pas utiliser le Service.</P>
        </div>
      </div>
        ...
        <main>
          ...
          <Section number="3" title="Création de compte et accès">
            ...
            <SubSection title="3.4 Sécurité du compte">
              <P>Vous êtes seul responsable de la confidentialité de vos identifiants de connexion et de toute activité réalisée depuis votre Compte. Vous devez nous informer immédiatement à <a href="mailto:support@usewok.com" style={{ color: ORANGE_DEEP }}>support@usewok.com</a> en cas d'accès non autorisé suspecté.</P>
            </SubSection>
          </Section>
          ...
          <Section number="8" title="Résiliation par l'Utilisateur">
            <P>Vous pouvez supprimer votre Compte à tout moment depuis les paramètres du Service. La suppression de votre Compte entraîne la suppression de vos données personnelles conformément à notre <Link to="/privacy" style={{ color: ORANGE_DEEP }}>Politique de Confidentialité</Link>, sous réserve des données que nous sommes légalement tenus de conserver (notamment les données de facturation, conservées 10 ans).</P>
          </Section>
          ...
          <Section number="11" title="Données personnelles">
            <P>Le traitement de vos données personnelles est régi par notre <Link to="/privacy" style={{ color: ORANGE_DEEP }}>Politique de Confidentialité</Link>, qui fait partie intégrante des présentes Conditions.</P>
          </Section>
          ...
          <Section number="14" title="Médiation à la consommation">
            ...
            <P>Vous pouvez également utiliser la plateforme européenne de résolution des litiges en ligne : <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" style={{ color: ORANGE_DEEP }}>ec.europa.eu/consumers/odr</a>.</P>
          </Section>
      ...
      <footer style={{ background: '#fff', borderTop: '1px solid rgba(21,19,15,0.10)', padding: '24px clamp(20px, 5vw, 60px)', textAlign: 'center' }}>
        <p style={{ fontSize: 12, color: INK_SOFT, margin: 0 }}>
          ...
          <Link to="/privacy" style={{ color: INK_SOFT, textDecoration: 'none' }}>Politique de confidentialité</Link>
          {' '}·{' '}
