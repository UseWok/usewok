...
import { Settings, Copy, AlertTriangle, Trash2, LayoutDashboard, Share2, ExternalLink, Sparkles, Code2, FileCode, CheckCircle2, Pencil, Download } from 'lucide-react';
      ...
      {hasComponent ? (
        viewMode === 'preview' ? (
          <div className="w-full h-full relative bg-white overflow-hidden">
            ...
            {/* ── Preview Toolbar: Export ZIP + Visual Edit — top right ── */}
            <div style={{ position: 'absolute', top: 10, right: 10, zIndex: 20, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 8 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                {/* Export ZIP — directly in toolbar */}
                <button
                  ...
                  onMouseEnter={e => { e.currentTarget.style.background = 'rgba(40,40,40,0.95)'; e.currentTarget.style.color = '#fff'; }}
                  onMouseLeave={e => { e.currentTarget.style.background = 'rgba(20,20,20,0.85)'; e.currentTarget.style.color = '#ccc'; }}
                  title="Export as ZIP"
                >
