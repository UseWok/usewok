...
export const ALL_MODES = [
  { id: 'ultimate', labelKey: 'mode_ultimate', descKey: 'mode_ultimate_desc', icon: Crown, model: 'gemini_3_1_pro', label: 'Expert',   desc: 'Le plus puissant',  requiredPlan: 'expert',    credit_cost: 4, credit_max: 9 },
