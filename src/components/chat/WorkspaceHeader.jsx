...
// ELITE HORIZONTAL GRADIENTS MAPPED TO THE XML DESIGN MODES
const AMBIANCES = [
  { id: 'wok_clean', name: 'Wok Clean', theme: 'wok_clean', previewGradient: 'linear-gradient(90deg, #FFFFFF 0%, #F5F5F5 100%)' },
  { id: 'deep_void', name: 'Deep Void', theme: 'deep_void', previewGradient: 'linear-gradient(90deg, #050505 0%, #1A1A1A 100%)' },
  { id: 'yuzu_accent', name: 'Yuzu Accent', theme: 'yuzu_accent', previewGradient: 'linear-gradient(90deg, #0A0A0A 0%, #E6FF00 100%)' },
  { id: 'corporate_sand', name: 'Corporate Sand', theme: 'corporate_sand', previewGradient: 'linear-gradient(90deg, #FDFBF7 0%, #EFEBE0 100%)' },
  { id: 'brutalism', name: 'Brutalism Light', theme: 'brutalism', previewGradient: 'linear-gradient(90deg, #E5E5E5 0%, #CCCCCC 100%)' }
];
    ...
    <>
      ...
      <header className="flex items-center justify-between px-4 h-[56px] flex-shrink-0 z-30 font-sans w-full bg-transparent absolute top-0 left-0 right-0">
        ...
        <div className="flex justify-center w-1/3 relative hidden md:flex">
          <div className={`px-4 py-1.5 rounded-full text-[11px] font-mono flex items-center gap-2 border ${isDark ? 'bg-black/40 border-white/10 text-white/70 backdrop-blur-md' : 'bg-white/80 border-[#E5E5E5] text-gray-500 shadow-sm backdrop-blur-md'}`}>
