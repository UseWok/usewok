...
export const ALL_MODES = [
  { id: 'ultimate', labelKey: 'mode_ultimate', descKey: 'mode_ultimate_desc', icon: Crown, model: 'claude_opus_4_6', label: 'Expert',   desc: 'Le plus puissant',  requiredPlan: 'expert',    credit_cost: 4, credit_max: 9 },
  ...
  { id: 'fast',     labelKey: 'mode_fast',     descKey: 'mode_fast_desc',     icon: Zap,   model: 'gpt_5',           label: 'Rapide',   desc: 'Mode rapide',       requiredPlan: null,        credit_cost: 2, credit_max: 5 },
];
