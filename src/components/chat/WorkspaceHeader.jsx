...
export default function WorkspaceHeader({ onReload, appearance, setAppearance }) {
  ...
  return (
    <header className={`flex items-center justify-between px-4 h-[48px] flex-shrink-0 z-30 font-sans w-full ${appearance?.theme !== 'classic' ? 'bg-transparent border-b border-black/5' : 'bg-[#F4F4F4] border-b border-[#E5E5E5]'}`}>
