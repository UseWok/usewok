...
// Gemini: gradient diamond SVG (official colors)
const GeminiLogo = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M12 2C12 2 9.5 8.5 2 12C9.5 15.5 12 22 12 22C12 22 14.5 15.5 22 12C14.5 8.5 12 2Z" fill="url(#gem-g)"/>
  </svg>
);

// Claude: official amber/terracotta icon
const ClaudeLogo = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
    <path d="M12 2L20.5 7V17L12 22L3.5 17V7L12 2Z" fill="#D97757"/>
    <path d="M8.5 15.5L12 8.5L15.5 15.5M9.5 13.5H14.5" stroke="white" strokeWidth="1.2" strokeLinecap="round"/>
  </svg>
);

const ENGINE_CFG = [
  { key: 'chatgpt',    label: 'ChatGPT',    logoEl: <ChatGPTLogo /> },
  { key: 'gemini',     label: 'Gemini',     logoEl: <GeminiLogo /> },
  { key: 'claude',     label: 'Claude',     logoEl: <ClaudeLogo /> },
