      ...
      <body>
        ...
        <script>
          ...
          window.onerror = function(message, source, lineno, colno, error) {
            ...
            window.parent.postMessage({ type: 'WOK_RUNTIME_ERROR', message: String(msg) }, '*');
            return true;
          };
          // Capture unhandled promise rejections
          window.addEventListener('unhandledrejection', function(e) {
            var msg = e.reason ? (e.reason.message || String(e.reason)) : 'Unhandled promise rejection';
            window.parent.postMessage({ type: 'WOK_RUNTIME_ERROR', message: msg }, '*');
          });
          // Capture console.error calls
          var _origConsoleError = console.error;
          console.error = function() {
            var args = Array.prototype.slice.call(arguments);
            var msg = args.map(function(a) { return typeof a === 'object' ? (a && a.message ? a.message : JSON.stringify(a)) : String(a); }).join(' ');
            window.parent.postMessage({ type: 'WOK_RUNTIME_ERROR', message: msg }, '*');
