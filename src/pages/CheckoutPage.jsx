...
import { loadPlansFromDB, getPlansConfig, DEFAULT_PLANS } from '@/lib/plans-config';
...
export default function CheckoutPage() {
  ...
  const handleCheckout = async () => {
    ...
    // Fallback to DEFAULT_PLANS to always resolve the price ID (fixes Elite)
    const def = DEFAULT_PLANS.find(d => d.id === plan.id) || {};
    const priceId = promoOn
      ? (plan.stripe_promo_price_id_monthly || def.stripe_promo_price_id_monthly)
