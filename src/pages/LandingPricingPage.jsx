  ...
  return (
    <div style={{ fontFamily: WIX, background: '#FAF9F6', color: '#15130F', minHeight: '100vh', WebkitFontSmoothing: 'antialiased' }}>
      <style>{`
        ...
        .uw-pricing .pricing-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 14px; margin: 74px auto 0; max-width: 960px; align-items: stretch; }
