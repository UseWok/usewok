...
function LivePreviewEngine({ content, appearance }) {
  ...
  return (
    <div className="w-full h-full flex flex-col" style={{ color: isDark ? '#E5E7EB' : '#1a1a1a', fontFamily: appearance?.font || 'inherit' }}>
      ...
      {isComponentCode ? (
        <div className="flex-1 flex flex-col w-full h-full border rounded-md overflow-hidden bg-white shadow-sm" style={{ borderColor: BORDER }}>
    ...
    <div className="flex flex-col h-full w-full p-6 md:p-10 overflow-y-auto" ref={scrollRef}>
      {content ? (
        ...
        <div className="flex flex-col items-center justify-center h-full w-full">
          {/* Abstract, modern geometric loader ideal for 'Sand' background */}
          <motion.div 
            animate={{ rotate: 360 }} 
