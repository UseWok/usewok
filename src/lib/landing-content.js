...
export const DEFAULT_LANDING = {
  ...
  pricing: {
    ...
    subtitle: 'A financial coach costs $200/hr. Stensor costs $9/mo — and never sleeps.',
    ...
    paid_title: 'Essential — your personal financial coach.',
    paid_price: '9',
    paid_currency: '$/mo',
    paid_features: [
      '100 credits/month — unlimited questions, real answers',
      'Advanced AI mode — deeper analysis, sharper strategies',
      'Unlimited discussions — build your full financial plan',
      'Attach your bank statements, salary slips, contracts',
      '10× cheaper than a human coach. 10× faster. Always available.',
    ],
    paid_cta: 'Start for $9/mo →',
    paid_url: '/tarifs',
  },
  faq: [
